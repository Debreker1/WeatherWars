                ...
                <div id="info" className="container-fluid text-center">
                    <div className="row">
                        <div className="col-md-12">
                            ...
                            <img className="img-center" src="https://i1.wp.com/metro.co.uk/wp-content/uploads/2018/02/ios_weather_icons-e1519660727179.png?quality=90&strip=all&zoom=1&resize=644%2C483&ssl=1" style={{height: 322, width: 421}}></img>
